...
if(isset($_POST['cat_delete'])){
 // $cat_id=$_POST['cat_id'];
  ...
  if($result){
    ...
    echo "<script> alert('category is deleted ,thanks :)')</script>";
  echo "<script> window.open('view_cat.php','_self')</script>";

  }
  echo "<script> alert('category is not deleted:)')</script>";
}
...
<center><h2 class ="text-align-center">delete category</h2><p>make sure you want delete this data !</p></center>
...
<div class="div2">
  <form action="" method="post" class="form-control"  enctype="multipart/form-data">
    ...
    <input class="bg-danger" type="submit" value="delete" name="cat_delete">
